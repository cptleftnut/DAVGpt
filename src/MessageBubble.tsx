...
// ⚡ Bolt Optimization: Memoize MessageBubble with a custom comparison function to prevent O(N) re-renders
// when the parent component's state (like input) changes. Inline function props like onRunCommand
// break default shallow comparison, so we explicitly compare primitive props.
