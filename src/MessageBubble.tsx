...
// ⚡ Bolt: Memoize MessageBubble with a custom comparator.
// The parent (App.tsx) passes inline functions (onRunCommand, onSpeak) which change reference
// on every parent re-render (e.g. when typing in the input textarea).
// This custom comparison only checks primitive data props to prevent O(N) re-renders
// of all messages in the list on every keystroke.
