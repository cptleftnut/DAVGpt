...
// Optimized with React.memo to prevent O(N) re-renders during parent state updates (like user typing).
// Custom comparison ignores inline function props (onRunCommand, onSpeak) as they change every render.
