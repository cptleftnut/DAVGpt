...
export default function Cortex({ apiKey, sendCommand, connState }: Props) {
  ...
  // ⚡ Bolt Optimization: Use lazy initialization for state variables that parse JSON from localStorage.
  // This prevents expensive synchronous disk I/O and JSON.parse() on every component re-render.
        ...
        {tab === 'dashboard' && (
          <div className="cortex-dashboard">
            ...
            <div className="pillar-grid">
              {[
                // ⚡ Bolt Optimization: Replace inline calls to loadChain() and loadDaemonLog() with their
                // respective state variables (chain, daemonLog) to prevent unnecessary localStorage access and JSON parsing during render.
