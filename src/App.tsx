...
function Chat({ session, environments, onUpdateSession, onOpenSidebar, bridge, switchToTerminal, mcpServers, onOpenMCP }: {
  ...
  return (
    <div className="chat-page">
      ...
      {activeSkill && <div className="skill-banner">{activeSkill.icon} {activeSkill.label}<button className="skill-clear" aria-label="Clear active skill" title="Clear skill" onClick={() => { setActiveSkill(null); setInput('') }}>✕</button></div>}
