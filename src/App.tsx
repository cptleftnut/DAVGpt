  ...
  return (
    <div className="chat-page">
      <header className="header">
        <button className="menu-btn" onClick={onOpenSidebar} aria-label="Toggle Sidebar">☰</button>
      ...
      <footer className="input-bar">
        <div className="input-wrap">
          {!isHermes && <button className="skill-btn" onClick={() => setShowSkills(true)} disabled={!apiKey} aria-label="Select skill">⚡</button>}
          {stt.supported && (
