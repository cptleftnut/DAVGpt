...
function Chat({ session, environments, onUpdateSession, onOpenSidebar, bridge, switchToTerminal, mcpServers, onOpenMCP }: {
  ...
  // ⚡ Bolt Optimization: Removed synchronous IO (loadIrisProfile which reads from localStorage)
  // from the render loop. It was unused here, causing unnecessary blocking on every keystroke.
