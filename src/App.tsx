  ...
  return (
    <div className="chat-page">
      <header className="header">
        <button className="menu-btn" onClick={onOpenSidebar} aria-label="Open menu" title="Open menu">☰</button>
      ...
      <footer className="input-bar">
        <div className="input-wrap">
          {!isHermes && <button className="skill-btn" onClick={() => setShowSkills(true)} disabled={!apiKey} aria-label="Open skills menu" title="Open skills menu">⚡</button>}
          {stt.supported && (
