  ...
  return (
    <div className="chat-page">
      <header className="header">
        <button className="menu-btn" onClick={onOpenSidebar} aria-label="Toggle sidebar" title="Toggle sidebar">☰</button>
        ...
        <div className="modal-overlay" onClick={() => apiKey && setShowSettings(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="setting-row">
              ...
              <button className={`toggle-btn ${tts.autoSpeak ? 'on' : ''}`} onClick={tts.toggleAutoSpeak} aria-label={tts.autoSpeak ? 'Disable auto-speak' : 'Enable auto-speak'} title={tts.autoSpeak ? 'Disable auto-speak' : 'Enable auto-speak'}>{tts.autoSpeak ? 'ON' : 'OFF'}</button>
            </div>
      ...
      <footer className="input-bar">
        <div className="input-wrap">
          {!isHermes && <button className="skill-btn" onClick={() => setShowSkills(true)} disabled={!apiKey} aria-label="Select skill" title="Select skill">⚡</button>}
          {stt.supported && (
