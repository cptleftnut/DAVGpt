...
function Chat({ session, environments, onUpdateSession, onOpenSidebar, bridge, switchToTerminal, mcpServers, onOpenMCP }: {
  ...
  // localStorage on every render (e.g. while typing).
  ...
  // ⚡ Bolt Optimization: Removed unused irisProfile and irisRoute variables
  // that were calling loadIrisProfile() (which reads localStorage) on every render.
