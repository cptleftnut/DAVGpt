                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" onClick={() => startRename(s)} aria-label="Rename chat" title="Rename">✏️</button>
                      <button className="sb-action del" onClick={() => onDelete(s.id)} aria-label="Delete chat" title="Delete">🗑️</button>
                    </div>
                  </div>
                )
              })}
