    ...
    <div className="sidebar-overlay" onClick={onClose}>
      <div className="sidebar" onClick={e => e.stopPropagation()}>
        ...
        <div className="sb-header">
          ...
          <button className="sb-close" aria-label="Close sidebar" onClick={onClose}>✕</button>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" onClick={() => startRename(s)} title="Rename" aria-label="Rename chat">✏️</button>
                      <button className="sb-action del" onClick={() => onDelete(s.id)} title="Delete" aria-label="Delete chat">🗑️</button>
                    </div>
                  </div>
                )
              })}
