                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      ...
                      <button className="sb-action del" onClick={() => { if (window.confirm('Are you sure you want to delete this chat?')) onDelete(s.id) }} title="Delete" aria-label="Delete chat">🗑️</button>
                    </div>
                  </div>
                )
              })}
