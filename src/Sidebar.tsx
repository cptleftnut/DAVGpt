                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" aria-label="Rename" onClick={() => startRename(s)} title="Rename">✏️</button>
                      <button className="sb-action del" aria-label="Delete" onClick={() => onDelete(s.id)} title="Delete">🗑️</button>
                    </div>
                  </div>
                )
              })}
