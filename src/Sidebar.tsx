    ...
    <div className="sidebar-overlay" onClick={onClose}>
      <div className="sidebar" onClick={e => e.stopPropagation()}>
        ...
        <div className="sb-header">
          ...
          <button className="sb-close" aria-label="Close sidebar" title="Close sidebar" onClick={onClose}>✕</button>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" aria-label="Rename chat" title="Rename chat" onClick={() => startRename(s)}>✏️</button>
                      <button className="sb-action del" aria-label="Delete chat" title="Delete chat" onClick={() => onDelete(s.id)}>🗑️</button>
                    </div>
                  </div>
                )
              })}
