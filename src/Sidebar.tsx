                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" aria-label="Rename chat" onClick={() => startRename(s)} title="Rename">✏️</button>
                      <button className="sb-action del" aria-label="Delete chat" onClick={() => onDelete(s.id)} title="Delete">🗑️</button>
                    </div>
                  </div>
                )
              })}
