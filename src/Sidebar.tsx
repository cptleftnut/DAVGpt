                ...
                return (
                  ...
                  >
                    ...
                    <div className="sb-actions" onClick={e => e.stopPropagation()}>
                      <button className="sb-action" onClick={() => startRename(s)} title="Rename" aria-label="Rename session">✏️</button>
                      <button className="sb-action del" onClick={() => onDelete(s.id)} title="Delete" aria-label="Delete session">🗑️</button>
                    </div>
                  </div>
                )
              })}
